...
class RPControlsConvert(Dtype):
    ...
    """
    def __init__(self, mode='identity', intervention_threshold=50.0):
        """
        Args:
    ...
    def save_file(self, data, filename):
        ...
        """
        np.save(filename+'/control.npy', data)
...
class RPWheelEncodersConvert(Dtype):
    ...
    def save_file(self, data, filename):
        ...
        This function should be implemented where the data of the whole trajectory is stored in one file, like imu, odometry, etc.
        """
        np.save(filename+'/encoder.npy', data)
...
class RPShockSensorsConvert(Dtype):
    ...
    def save_file(self, data, filename):
        ...
        This function should be implemented where the data of the whole trajectory is stored in one file, like imu, odometry, etc.
        """
        np.save(filename+'/shock.npy', data)
