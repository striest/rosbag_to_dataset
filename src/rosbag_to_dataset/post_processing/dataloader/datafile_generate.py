...
data_root_dir = '/project/learningphysics/tartandrive_trajs_parv_final/train'
outfile = '/project/learningphysics/tartandrive_trajs_parv_final/train/trainframes.txt'
f = open(outfile, 'w')
